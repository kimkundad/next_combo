<div id="kt_app_sidebar" 
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" style="justify-content: center;">
        ...
        <a target="_blank" href="{{ url('/')}}">
            ...
            <img src="{{ url('img/logo_head.png') }}" alt="Logo" class="h-35px app-sidebar-logo-default" />
               
            <img src="{{ url('img/logo_head.png') }}" alt="Logo" class="h-35px app-sidebar-logo-minimize" />
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/case*')) ? 'active' : '' }}" href="{{ url('admin/case') }}">
                        ...
                        <span class="menu-title">Case ทั้งหมด</span>
                    </a>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/report*')) ? 'active' : '' }}" >
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">รายงาน ทั้งหมด</span>
                    </a>
                    <!--end:Menu link Gallery --> 
                </div>
