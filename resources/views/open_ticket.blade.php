                ...
                <div class="p-26">
                    ...
                    <div>
                        <p class="mb-0 text-danger fs-10px-red">
                            ...
                            ลายหมัด ไรในหู ไรขี้เรื้อนแห้ง หรือหากไม่มีรอยโรคชัดเจน สามารถอัพโหลดรูปขณะกำลังใช้โปรแกรม Next COMBO ได้เลย <br>(อัพโหลดได้สูงสุด 3 รูป)
                        </p>
...
<div class="box-height-10"></div>
                    <div class="box-height-10"></div>
                    <p class="text-success text-center" style="font-size:16px">ทีมงานจะมีการตรวจสอบรูปที่ท่านส่งมาอีกคร้ัง <br> การตัดสินของทีมงานถือเป็นที่สิ้นสุด</p>
                    <div class="mt-3">
