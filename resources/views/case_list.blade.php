...
@section('content')
    ...
    <div id="main">
                    ...
                    <div class="list list-row" id="list-row">
                        ...
                        @isset($ticket)
                            ...
                            <div class="list-item border-bottom" id="dv_{{ $item->id }}" data-order="{{ $item->id }}">
                                ...
                                <div>
                                    @if($item->close_ticket !== 0)
                                    <a href="{{ url('detail_ticket/'.$item->id) }}" style="color:#5e676f">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right mx-2"><polyline points="9 18 15 12 9 6"></polyline></svg>
                                    </a>
                                    @else
                                    <a href="{{ url('close_ticket/'.$item->id) }}">
                                        <img class="camera-green" src="{{ url('img/camera.jpg') }}" alt="">
                                    </a>
                                    @endif
                                </div>
        ...
        <video id="VisaChipCardVideo" style="max-width: 356px;"  controls>
            <source src="https://kimspace2.sgp1.cdn.digitaloceanspaces.com/next_combo/2024_BI_VDO_NexGard_Combo.mp4" style="min-width: 446px; max-width: 660px;" type="video/mp4">
